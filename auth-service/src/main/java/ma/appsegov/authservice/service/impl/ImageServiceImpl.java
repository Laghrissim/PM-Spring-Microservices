...
public class ImageServiceImpl implements ImageService {
    ...
    private final Path root = Paths.get(new File("auth-service/src/main/resources/ProfileImages").getAbsolutePath());
    ...
    public String saveImage(MultipartFile file) throws IOException {
        ...
        String fileUrl = "http://localhost:8081/auth-service/api/profile/" + uniqueFileName;
        return fileUrl;
    }
